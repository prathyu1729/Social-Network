...
while($row_posts=mysqli_fetch_array($run_posts))
{
	...
	function get_posts()
	{
		...
		$get_posts = "select * from posts ORDER by post_id DESC LIMIT $per_page";
		...
		if(isset($_GET['post_id']))
		{
			...
			else 
			{
				...
				if(isset($_POST['reply']))
				{
					...
					if($comment == "")
					{
						echo "<script>alert('Comment not entered')</script>";
	...
	function search_user()
	{
		...
		if(isset($_GET['search_user_btn']))
		{
			...
			$get_user = "SELECT * FROM user WHERE f_name LIKE '%$search_query%' OR l_name LIKE '%$search_query%'";
		}
		else {
				...
				<div class='col-sm-6'>
					<div class='row' id='find_people'>
						<div class='col-sm-4'>
							...
							<img src='users/$user_image' width='150px' height='140px' title='$f_name' style='float: left; margin: 1px;'/>
							</a>
						</div><br><br>
						<div class='col-sm-6'>
